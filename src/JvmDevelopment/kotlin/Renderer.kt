...
class Renderer(val instance: Any) {
    ...
    private val sceneProperty = instance::class.memberProperties.find { it.name == "scene" }!! as KMutableProperty1<Any, Any>
    private val pAppletProperty = instance::class.memberProperties.find { it.name == "pApplet" }!! as KProperty1<Any, Any>
